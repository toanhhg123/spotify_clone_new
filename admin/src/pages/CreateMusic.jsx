...
const CreateMusic = () => {
  ...
  const handelCallApi = async()=>{
    return await insert({singer:singer,title:title,duration:duration,img:img,audio:audio})
  }
  ...
  return (
    <>
      ...
      {musicState.payload?.massage && <Toast massage={musicState.payload.massage} type={musicState.payload.status}/>}
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <form className="forms-sample" onSubmit={handelOnSubmit}>
                      ...
                      <div className="form-group">
                        <label htmlFor="exampleInputPassword4">Duration (seconds)</label>
                        <input
                          type="number"
                          value={duration || ''}
                          onChange={(e) => {onAudioChange(e); handelTime(e);}}
                          className="form-control"
                        />
                      </div>
                      <button type="submit"
